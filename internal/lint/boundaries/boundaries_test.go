...
func TestBoundaries(t *testing.T) {
	cases := []struct {
		...
		{"internal/arr", []string{"github.com/santiagosayshey/recall/internal/arr/arrtest"}, 0},
		{"internal/register", []string{"github.com/santiagosayshey/recall/internal/arr", "github.com/santiagosayshey/recall/internal/config"}, 0},
		{"internal/register", []string{"github.com/santiagosayshey/recall/internal/store"}, 1},
